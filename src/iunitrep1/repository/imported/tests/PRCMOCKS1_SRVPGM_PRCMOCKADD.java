...
public class PRCMOCKS1_SRVPGM_PRCMOCKADD {

	static String inputXMLFilePath = "testcases/iunitrep1.repository.imported.tests/PRCMOCKS1_SRVPGM_PRCMOCKADD.xml";
	String input;
	...
	public PRCMOCKS1_SRVPGM_PRCMOCKADD(String input, String expectedResult, String compareJson, String index) {
		this.input = input;
	...
	public static Collection<String[]> testData() {
		return IUnitXMLParser
				.getParameters("resources/iunitrep1.repository.imported.tests/PRCMOCKS1_SRVPGM_PRCMOCKADD");
	}
