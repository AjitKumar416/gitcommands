...
public class GENPROC_MODULE_ADD {

	static String inputXMLFilePath = "testcases/iunitrep1.repository.imported.tests/GENPROC_MODULE_ADD.xml";
	String input;
	...
	public GENPROC_MODULE_ADD(String input, String expectedResult, String compareJson, String index) {
		this.input = input;
	...
	public static Collection<String[]> testData() {
		return IUnitXMLParser.getParameters("resources/iunitrep1.repository.imported.tests/GENPROC_MODULE_ADD");
	}
