...
public class GENPROC_MODULE_MULTIPLY_1 {

	static String inputXMLFilePath = "testcases/iunitrep1.repository.imported.tests/GENPROC_MODULE_MULTIPLY_1.xml";
	String input;
	...
	public GENPROC_MODULE_MULTIPLY_1(String input, String expectedResult, String compareJson, String index) {
		this.input = input;
	...
	public static Collection<String[]> testData() {
		return IUnitXMLParser.getParameters("resources/iunitrep1.repository.imported.tests/GENPROC_MODULE_MULTIPLY_1");
	}
